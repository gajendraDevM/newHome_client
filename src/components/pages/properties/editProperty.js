...
import {propertySelector, fetchOneproperty, editproperty} from '../../../api/PropertySlice'
...
export default function Createclient() {
 ...
 const { client, current_client } = useSelector(clientSelector)
  const { current_property } = useSelector(propertySelector)
  const [imge, setImge] = useState(current_property.property_gallery)
...
useEffect(()=>{
    ...
    dispatch(fetchOneproperty(id))

    current_property &&   form.setFieldsValue({
        project_name: current_property.project_name,
         phone_number: current_property.phone_number,
         description: current_property.description,
      property_info:{

        balconies:current_property.property_info.bath_room,
        bed_room:current_property.property_info.bed_room,
        build_effeciency:current_property.property_info.build_effeciency,
        builtup_area:current_property.property_info.builtup_area,
        car_parking:current_property.property_info.car_parking,
        construction_status:current_property.property_info.construction_status,
        deposit:current_property.property_info.deposit,
        escalation:current_property.property_info.escalation,
        floor:current_property.property_info.floor,
        lock_in:current_property.property_info.lock_in,
        notice_period:current_property.property_info.notice_period,
        offered_area:current_property.property_info.offered_area,
        ownership_type:current_property.property_info.ownership_type,
        power:current_property.property_info.power,
        price_unit:current_property.property_info.price_unit,
        property_age:current_property.property_info.property_age,
        property_facing:current_property.property_info.property_facing,
        rent:current_property.property_info.rent,
        rent_free_period:current_property.property_info.rent_free_period,
        sale_type:current_property.property_info.sale_type,
        site_area:current_property.property_info.site_area,
        store_room:current_property.property_info.store_room,
        total_floor:current_property.property_info.total_floor,
        water:current_property.property_info.water

      },

      owner_info: {
        address:current_property.owner_info.address,
        contact_by:current_property.owner_info.contact_by,
        email:current_property.owner_info.email,
        key_relation:current_property.owner_info.key_relation,
        land_mark:current_property.owner_info.land_mark,
        ...
        furnished_info:{
            ...
            EPABX:current_property.furnished_info.EPABX,
            airconditioning:current_property.furnished_info.airconditioning,
            conference_room:current_property.furnished_info.conference_room,
            // date_of_furnishing:current_property.furnished_info.date_of_furnishing,
            discussion_room:current_property.furnished_info.discussion_room,
            electrical_room:current_property.furnished_info.electrical_room,
            furnished_status:current_property.furnished_info.furnished_status,
            pantry:current_property.furnished_info.pantry,
            project_head:current_property.furnished_info.project_head,
            server_room:current_property.furnished_info.server_room,
            training_room:current_property.furnished_info.training_room,
        ...
        property_type:{
          ...
          Signage:current_property.property_type.Signage,
          client_catagory:current_property.property_type.client_catagory,
          corner_type:current_property.property_type.corner_type,
          power_type:current_property.property_type.power_type,
          property_catagory:current_property.property_type.property_catagory,
          property_type_info:current_property.property_type.property_type_info,
          vastu:current_property.property_type.vastu,
...
console.log(current_property);
    ...
    const onFinish = (values) => {
        ...
        dispatch(editproperty(id, values))
        form.resetFields()
      };
